    ...
    L.Control.StyleEditor = L.Control.extend({
        ...
        createUi: function () {
            ...
            var styleEditorDiv = this.options.styleEditorDiv =
                L.DomUtil.create('div', 'leaflet-styleeditor', this.styleEditor.map._container);
        ...
        _layerIsIgnored: function (layer) {
            ...
            return this.options.ignoreLayerTypes.some(function (layerType) { return layer.styleEditor && layer.styleEditor.type.toUpperCase() === layerType.toUpperCase(); });
        }
    });
