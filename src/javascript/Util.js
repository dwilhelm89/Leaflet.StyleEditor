...
L.StyleEditor.Util = L.Class.extend({
    ...
    */
    rgbToHex: function(rgb, no_hash) {
        ...
        let rgb_array = rgb.substring(4).replace(')', '').split(',')
        let without_hash = this._componentToHex(parseInt(rgb_array[0], 10)) + this._componentToHex(parseInt(rgb_array[1], 10)) +
            this._componentToHex(parseInt(rgb_array[2], 10))
