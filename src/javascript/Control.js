...
export default function setupControl () {
  L.Control.StyleEditor = L.Control.extend({
    ...
    addLeafletDrawEvents: function () {
      ...
      this.options.map.on(L.Draw.Event.CREATED, this.onEvent, this)
    },
    ...
    addLeafletEditableEvents: function () {
      ...
      this.options.map.on('layeradd', this.onLayerAdd, this)
      this.options.map.on('editable:created', this.onEvent, this)
    },

    onEvent: function (layer) {
    ...
    removeEventListeners: function () {
      ...
      if (L.Draw) {
        this.options.map.off(L.Draw.Event.CREATED, this.onEvent)
      }
      if (L.Editable) {
        this.options.map.off('editable:created', this.onEvent)
      }
    },
